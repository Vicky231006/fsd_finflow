  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-bg p-4">
      <div className="w-full max-w-md bg-surface border border-border rounded-3xl p-8 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-32 h-32 bg-accent-purple/20 blur-[50px] -z-10 rounded-full"></div>
        <div className="text-center mb-8">
          ...
          <p className="text-text-secondary mt-2">Create your FinFlow AI account</p>
        </div>
